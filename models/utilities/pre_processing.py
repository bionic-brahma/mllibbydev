...
def auto_oversample(x, y, class_ratio_threshold=0.3, increase_to_ratio=0.30, kpoint=5, method=None):
    """
    ...
    synth = oversampling(method=method)
    ...
    returnX, returny = sp.shuffle_data(returnX, returny)
